...
//      Đông nguyễn
    @Query(value = " select * from contract \n" +
            ...
            " and customer.customer_name like concat('%',:name,'%') \n" +
...
//                                                         @Param("start1") String start1,
                                                         @Param("end") String end,
//                                                         @Param("end1") String end1,
...
//      Đông nguyễn
    ...
    void editContract(Integer contractexpired, String contractdatestart,
            ...
            ,Integer contractdeposit,String contracttaxcode,String contractimageurl,String code,Integer check_flag,Integer contractid);
