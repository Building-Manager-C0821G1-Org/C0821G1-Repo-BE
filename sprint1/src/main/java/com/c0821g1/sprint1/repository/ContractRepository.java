...
public interface ContractRepository extends JpaRepository<Contract, Integer> {
    ...
    @Query(value = "update Contract as c " +
            "set c.contract_expred =?1,c.contract_date_start =?2,c.contract_date_end =?3" +
    ...
    void editContract(String contract_expred, String contract_date_start,
    ...
    @Modifying
    @Transactional
    @Query(value = "insert into Contract(contract_expred,contract_date_start," +
    ...
    void saveContract(String contract_expred, String contract_date_start,
